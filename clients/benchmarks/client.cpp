...
try
{
    ...
    desc.add_options()
        ...
        ("alpha_i",
          value<double>(&arg.alpha_i)->default_value(0.0), "specifies the scalar alpha for imaginary part")

        ("beta",
         value<double>(&arg.beta)->default_value(0.0), "specifies the scalar beta")

        ("beta_i",
         value<double>(&arg.beta_i)->default_value(0.0), "specifies the scalar beta for imaginary part")
